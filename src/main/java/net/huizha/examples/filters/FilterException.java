...
/**
 * Exception that can be thrown during session validation.
 *
 * @author Zhahui
 *
 */
public class FilterException extends RuntimeException {
     ...
     * Serial version UID
     */
    private static final long serialVersionUID = 3617021304778316787L;
     ...
     */
    protected FilterException(String message, Throwable cause, boolean enableSuppression,
